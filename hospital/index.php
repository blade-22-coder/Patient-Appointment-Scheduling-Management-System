...
<head>
    ...
    <title>Patient Appointment Scheduling Management System </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      <header id="menu-jk">
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">PASMS
        ...
        <div class="carousel-inner">
            <div class="carousel-item ">
                ...
                <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 class="animated bounceInDown"> Patient Appointment Scheduling Management System</h5>
                </div>
            </div>
...
?>
   ...
   <div class="copy" style="text-align: right; font-family: 'Times New Roman', Times, serif;">
    <div class="container">
       <b>Patient Appointment Scheduling Management System | It's Me </b>            
    </div>
</div>
</body>
